...
def play():
    ...
    return render_template('play.html', videoUrl=videoUrl, startTime=startTime)
...
def execute_tester():
    ...
    if dateString:
        ...
        return render_template('results.html', results=results, dateString=dateString, timestamps=timestamps, data=data, get_video_url_and_start_time=get_video_url_and_start_time)
    else:
